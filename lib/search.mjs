...
export async function search(path, opts = {}) {
  ...
  if (opts.musicbrainzTrackId)
    wheres.push(eq(Tracks.musicbrainzTrackId, opts.musicbrainzTrackId));
  if (opts.musicbrainzAlbumId)
    wheres.push(eq(Tracks.musicbrainzAlbumId, opts.musicbrainzAlbumId));
  if (opts.musicbrainzRecordingId)
    wheres.push(eq(Tracks.musicbrainzRecordingId, opts.musicbrainzRecordingId));
  if (opts.musicbrainzArtistId)
    wheres.push(
      like(Tracks.musicbrainzArtistId, `%${opts.musicbrainzArtistId}%`),
    );
